...
/**
 * 无限生产样例，用queue的方式存放生产链，执行到特定item，进行生产特定数量;
 * 一旦亏空，立即生产
...
public class LinkedBlockingDeque<E extends Item>
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        LinkedBlockingDeque queue = new LinkedBlockingDeque(Constant.count * temp);
...
//        Item2.executorService.execute(() -> {
        int t = 0;
        while (true) {
            Item take = null;
            try {
                take = queue.take();
//                System.out.println(take.index + ":" + queue.size());
            } catch (InterruptedException e) {
                System.out.println("出错了");
                e.printStackTrace();
            }
            if (take == null) {
                System.out.println("队列空了" + queue.size());
                System.exit(0);
            }
            take.run();
            i.getAndIncrement();
...
//
//                    System.out.println("获取到的内容下标" + take.index);
//                    try {
//                        Thread.sleep(10L);
//                    } catch (InterruptedException e) {
//                        e.printStackTrace();
...
//        }
     ...
     */
    static final class Node<E extends Item> {
        /**
...
//     }
     ...
     */
    static final class LBDSpliterator<E extends Item> implements Spliterator<E> {
